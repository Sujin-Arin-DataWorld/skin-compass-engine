...
const ZONES_DEF: ZoneDef[] = [
  ...
  },
  {
    zone: "cheeks",
    outlinePath:
      "M 81 268 C 77 288, 64 323, 70 352 C 74 376, 86 395, 104 403 C 124 410, 155 397, 172 376 C 183 363, 187 346, 179 333 C 166 306, 133 288, 106 275 C 94 271, 85 269, 81 268 Z M 424 268 C 428 288, 441 323, 435 352 C 431 376, 419 395, 401 403 C 381 410, 350 397, 333 376 C 322 363, 318 346, 326 333 C 339 306, 372 288, 399 275 C 411 271, 420 269, 424 268 Z",
    annotLine: { x1: 60, y1: 345, x2: 20, y2: 345 },
    hitPath: "M 55 265 L 185 265 L 185 415 L 55 415 Z M 320 265 L 450 265 L 450 415 L 320 415 Z",
  },
  {
    zone: "mouth",
    outlinePath:
      // M: 왼쪽 시작점 (191 -> 181, 362 -> 422)
      "M 181 422 " +
      // C: 왼쪽 상단 곡선
      "C 192 416, 225 410, 260 410 " +
      // C: 오른쪽 상단 곡선
      "C 295 410, 328 416, 339 422 " +
      // C: 오른쪽 끝 곡선 (341 -> 351, 390 -> 450)
      "C 351 428, 356 438, 351 450 " +
      // C: 오른쪽 하단 곡선
      "C 345 462, 330 478, 316 485 " +
      // C: 턱 중앙으로 오는 곡선 (435 -> 495)
      "C 299 492, 279 495, 270 495 " +
      // C: 왼쪽 하단으로 가는 곡선
      "C 251 495, 231 492, 214 485 " +
      // C: 왼쪽 끝 곡선 (179 -> 169, 390 -> 450)
