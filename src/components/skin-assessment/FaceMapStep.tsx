...
const ZONES_DEF: ZoneDef[] = [
  ...
  },
  {
    zone: "nose",
    outlinePath:
      "M 224 201 C 232 210, 228 228, 226 257 C 224 281, 216 310, 209 334 C 204 349, 200 361, 204 373 C 212 387, 238 393, 256 394 C 274 393, 300 387, 308 373 C 312 361, 308 349, 302 334 C 296 310, 288 281, 286 257 C 284 228, 281 210, 286 201 C 278 198, 234 198, 224 201 Z",
    annotLine: { x1: 260, y1: 228, x2: 260, y2: 308 },
    hitPath: "M 195 198 L 317 198 L 317 403 L 195 403 Z M 303 248 L 450 248 L 450 278 L 303 278 Z",
  },
  {
    zone: "eyes",
    outlinePath:
  ...
  },
  {
    zone: "cheeks",
    outlinePath:
      "M 190 292 C 192 302, 185 317, 182 332 C 175 347, 175 372, 175 387 C 175 397, 170 405, 160 409 C 140 417, 95 407, 88 382 C 85 342, 100 302, 117 287 C 140 297, 180 297, 190 292 Z M 330 292 C 340 297, 380 297, 403 287 C 420 302, 435 342, 432 382 C 425 407, 380 417, 360 409 C 350 405, 345 397, 345 387 C 345 372, 345 347, 338 332 C 335 317, 328 302, 330 292 Z",
    annotLine: { x1: 110, y1: 352, x2: 30, y2: 352 },
    hitPath: "M 80 282 L 200 282 L 200 422 L 80 422 Z M 320 282 L 440 282 L 440 422 L 320 422 Z",
  },
  {
    zone: "mouth",
    outlinePath:
      ...
      "M 181 422 " +
      // C: 왼쪽 입꼬리 -> 왼쪽 윗입술 산
      "C 195 415, 205 410, 220 410 " +
      // C: 왼쪽 윗입술 산 -> 중앙 움푹 파인 곳 (0.35cm / 7px 내려감)
      "C 235 410, 245 417, 260 417 " +
      // C: 중앙 움푹 파인 곳 -> 오른쪽 윗입술 산 (완벽한 대칭)
      "C 275 417, 285 410, 300 410 " +
      // C: 오른쪽 윗입술 산 -> 오른쪽 입꼬리
      "C 315 410, 325 415, 339 422 " +
      // C: 오른쪽 입꼬리 -> 오른쪽 하단 바깥
      "C 349 428, 355 438, 349 450 " +
      // C: 오른쪽 하단 바깥 -> 오른쪽 아랫입술
      "C 335 462, 320 478, 306 485 " +
      // C: 오른쪽 아랫입술 -> 턱 중앙 하단
      "C 289 492, 280 495, 260 495 " +
      // C: 턱 중앙 하단 -> 왼쪽 아랫입술 (대칭 적용)
      "C 240 495, 231 492, 214 485 " +
      // C: 왼쪽 아랫입술 -> 왼쪽 하단 바깥
      "C 200 478, 185 462, 171 450 " +
      // C: 왼쪽 하단 바깥 -> 시작점(왼쪽 입꼬리)으로 돌아감
      "C 165 438, 171 428, 181 422 Z",
    annotLine: { x1: 355, y1: 450, x2: 440, y2: 455 },
    hitPath: "M 155 405 L 365 405 L 365 500 L 155 500 Z M 345 440 L 460 440 L 460 470 L 345 470 Z",
  },
  {
    zone: "jawline",
    outlinePath:
      ...
      "M 108 418 " +
      // C: 턱선 왼쪽 바깥쪽 곡선
      "C 105 440, 110 470, 125 490 " +
      "C 140 515, 165 540, 195 555 " +
      "C 220 570, 242 575, 260 575 " + // x=260이 얼굴의 정확한 중앙입니다.
      // C: 턱선 오른쪽 바깥쪽 곡선 (왼쪽과 완벽한 거울 대칭)
      "C 278 575, 300 570, 325 555 " +
      "C 355 540, 380 515, 395 490 " +
      "C 410 470, 415 440, 412 418 " + // 오른쪽 바깥 끝부분 도착
      // C: 입술 밑 안쪽 라인 (오른쪽에서 중앙으로) - 파란 선처럼 y좌표를 깊게 내림
      "C 380 470, 320 520, 260 520 " +
      // C: 입술 밑 안쪽 라인 (중앙에서 왼쪽으로) - 자연스럽고 대칭되게 연결
      "C 200 520, 140 470, 108 418 Z",
    annotLine: { x1: 130, y1: 510, x2: 55, y2: 520 },
    hitPath: "M 95 410 L 425 410 L 425 580 L 95 580 Z M 40 505 L 130 505 L 130 535 L 40 535 Z",
  }, {
    zone: "neck",
    outlinePath:
      "M 140 557 C 200 600, 320 600, 380 557 C 390 586, 395 615, 390 644 C 340 670, 290 680, 260 680 C 230 680, 180 670, 130 644 C 125 615, 130 586, 140 557 Z",
    annotLine: { x1: 300, y1: 590, x2: 430, y2: 595 },
    hitPath: "M 95 480 L 425 480 L 425 700 L 95 700 Z",
  },
];
