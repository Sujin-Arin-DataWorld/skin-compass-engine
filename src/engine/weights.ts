...
export const PRODUCT_CATALOG: Record<string, Product> = {
  ...
  snature_toner: { id: "snature_toner", name: "S.NATURE Aqua Oasis Toner", brand: "S.NATURE", phase: "Phase2A", type: "Hydration Toner", price_eur: 14, tier: ["Entry"], shopify_handle: "snature-aqua-oasis-toner", key_ingredients: ["Hyaluronic Acid", "Panthenol", "Alcohol-Free"], target_axes: ["hyd"], for_skin: ["all"], image: `${IMAGE_SERVER_URL}&sig=snature_toner`, texture_feel: "Watery layer, instant absorption" },
  aestura_cream: { id: "aestura_cream", name: "Aestura AtoBarrier365 Cream", brand: "Aestura", phase: "Phase2B", type: "Barrier Cream", price_eur: 38, tier: ["Full", "Premium"], shopify_handle: "aestura-atobarrier365-cream", key_ingredients: ["Ceramide NP", "Squalane", "Cholesterol", "Panthenol"], target_axes: ["bar", "hyd", "sen"], for_skin: ["sensitive", "dry", "combination"], image: `${IMAGE_SERVER_URL}&sig=aestura_cream`, texture_feel: "Intense barrier milk, cocoon-like" },
  snature_squalane: { id: "snature_squalane", name: "S.NATURE Aqua Squalane Serum", brand: "S.NATURE", phase: "Phase2B", type: "Squalane Serum", price_eur: 20, tier: ["Entry", "Full"], shopify_handle: "snature-aqua-squalane-serum", key_ingredients: ["Squalane", "Panthenol", "Allantoin"], target_axes: ["bar", "hyd"], for_skin: ["all"], image: `${IMAGE_SERVER_URL}&sig=snature_squalane`, texture_feel: "Weightless oil-serum, velvet dry-down" },
  ...
  bioheal_probioderm: { id: "bioheal_probioderm", name: "Bioheal BOH Probioderm Serum", brand: "Bioheal BOH", phase: "Phase2C", type: "Premium Microbiome Serum", price_eur: 42, tier: ["Premium"], shopify_handle: "bioheal-boh-probioderm-collagen-remodeling-serum", key_ingredients: ["Patented Biome Complex", "12 Peptides", "Collagen"], target_axes: ["bar", "sen", "aging"], for_skin: ["all"], texture_feel: "Rich serum, skin-second feel" },
  ...
  iope_retinol: { id: "iope_retinol", name: "IOPE Retinol Super Bounce Serum", brand: "IOPE", phase: "Phase3_Aging", type: "Retinol Serum", price_eur: 52, tier: ["Full", "Premium"], shopify_handle: "iope-retinol-super-bounce-serum", key_ingredients: ["Retinal", "Peptides", "Hyaluronic Acid"], target_axes: ["aging", "texture"], for_skin: ["all"], image: `${IMAGE_SERVER_URL}&sig=iope_retinol`, texture_feel: "Bounce serum, collagen-cloud feel" },
