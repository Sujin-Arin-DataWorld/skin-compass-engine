...
const ABOUT_COPY = {
  ko: {
    ...
    manifesto: [
      ...
      "타협은 없습니다. 피부 전문적인 논문으로 검증된 성분, 투명하게 공개된 함량까지. 확실한 효과를 자부하며 엄선한 진짜 스킨케어만을 큐레이션합니다.",
  ...
  en: {
    ...
    manifesto: [
      ...
      "We don\u2019t compromise. Backed by professional cosmetic research and fully transparent ingredient concentrations, we confidently curate only highly effective products that deliver undeniable results.",
  ...
  de: {
    ...
    manifesto: [
      ...
      "Wir machen keine Kompromisse. Basierend auf kosmetischen Studien und absolut transparenten Wirkstoffkonzentrationen kuratieren wir voller Überzeugung nur hochwirksame Produkte die echte Ergebnisse liefern.",
