    ...
    sections: [
        {
            ...
            blocks: [
                ...
                "• 회원 가입 및 관리: 이메일 주소, 이름을 통한 회원 식별 및 계정 관리\n• 피부 진단 서비스 제공: 설문 응답 데이터 기반 10축 피부 벡터 분석 및 맞춤형 제품 추천\n• AI 피부 진단: 얼굴 사진을 활용한 AI 기반 실시간 피부 분석 (아래 제3조 참조)\n• 주문 처리 및 배송: 구매 내역 관리, 배송지 저장",
            ],
        },
        {
            ...
            blocks: [
                "회사는 다음의 개인정보를 수집합니다:",
                "**필수 수집 항목:**\n• Google 계정 연동 시: 이메일 주소, 이름(성·이름), 프로필 사진 URL\n• 이메일 가입 시: 이메일 주소, 이름, 비밀번호(암호화 저장)\n• 피부 진단 시: 설문 응답 데이터, 피부 축 점수, 피부 등급",
                "**민감정보 (선택):**\n• AI 피부 진단 이용 시: 얼굴 사진 (생체인식정보에 해당, 제3조에 따라 별도 동의 후 즉시 파기)",
                "**자동 수집 항목:**\n• 접속 로그, 브라우저 정보, IP 주소 (서버 로그 파일)",
            ],
        },
        {
            title: "제3조 (AI 피부 진단 — 민감정보(생체인식정보) 처리)",
            blocks: [
                "회사의 AI 피부 진단 기능 이용 시 이용자의 얼굴 사진이 처리됩니다. 얼굴 사진은 「개인정보 보호법」 제23조에 따른 민감정보(생체인식정보)에 해당합니다.",
        ...
        },
        {
            ...
            blocks: [
                ...
                "AI 피부 진단을 위한 얼굴 사진은 분석 완료 즉시 파기되며, 별도로 보관하지 않습니다.",
