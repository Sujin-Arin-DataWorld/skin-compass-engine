  ...
  return (
    <motion.svg
      ...
      <motion.text
        ...
        opacity={0.85}
        fontSize={12} fontFamily="var(--font-body)" fontWeight={500} letterSpacing="0.04em"
        initial={{ opacity: 0 }}
      ...
      <section className="relative flex min-h-screen items-center px-6 pt-20 overflow-hidden">
        <div className="mx-auto grid max-w-[1100px] w-full gap-12 md:grid-cols-2 md:items-center">
          ...
          <motion.div
            ...
            <SkinRadar />
            <p className="absolute -bottom-2 text-[9px] text-muted-foreground tracking-wide w-full my-0 text-right">
