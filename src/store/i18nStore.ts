...
export const translations = {
    ...
    de: {
        ...
        orders: "Bestellungen",
        logout: "Abmelden",
        noDiagnosis: "Noch keine Diagnose vorhanden.",
        startNow: "Jetzt starten →",
        myVector: "Mein Skin-Vektor (10 Achsen)",
        myRoutine: "Meine Routine (5 Formeln)",
        diagnosesSaved: "Diagnosen gespeichert",

        // Hero Data
        heroTitle: "Klinische Präzision.",
        heroSlogan: "Erweiterte diagnostische Intelligenz. 10-Achsen-Vektorprofilierung.",
        ...
        index: {
            journey: [
                { title: "Kontext-Setup", subtitle: "Alter, Umwelt & Lebensstil als Basis", desc: "Wir beginnen mit der Erfassung Ihrer Umwelt- und Lebensstilparameter. Jede algorithmische Entscheidung berücksichtigt Ihr lokales Klima und Ihre tägliche Routine.", accent: "30 Sek" },
                { title: "Biometrischer Symptom-Check", subtitle: "120 klinische Marker werden bewertet", desc: "Unsere Diagnose-Engine bewertet Ihre Haut in mehreren Dimensionen basierend auf IGA, TEWL und MASI — exakt den klinischen Skalen, die in der dermatologischen Forschung verwendet werden.", accent: "3-5 Min" },
                { title: "Datengetriebene Analyse", subtitle: "Berechnung auf 10 Achsen", desc: "Ihre Antworten erzeugen einen einzigartigen biometrischen Hautvektor. Wir ordnen Sie nicht in einen generischen \"Hauttyp\" ein. Ihre klinischen Metriken steuern die gesamte Empfehlungs-Engine.", accent: "< 3 Sek" },
                { title: "Ihr gezieltes Protokoll", subtitle: "5-Phasen K-Beauty-Routine", desc: "Jede Produktempfehlung durchläuft einen doppelten Filter: dermatologische Wirksamkeit für Ihren spezifischen Datenvektor und EU-konforme Sicherheitsstandards. Kein Raten.", accent: "Personalisiert" }
            ],
            ...
            matchAccuracy: "Routine-Fit: 98.4% Genauigkeit",
            progress: {
                week2: "Woche 2",
                week6: "Woche 6",
            ...
            authority: {
                confidence: "Diagnostische Sicherheit",
                axes: "Klinische Achsen",
                markers: "Validierte Marker",
                phase: "Phasenprotokoll",
                realResults: "Echte Ergebnisse. Sichtbarer Fortschritt.",
                realResultsSub: "Sehen Sie, wie ein klinisch abgestimmtes K-Beauty-Protokoll Ihre Haut im Laufe der Zeit transformiert."
            },
            diagnosisMeets: "Diagnose trifft Schönheit.",
            ...
            tenAxisAnalysis: "10-Achsen Hautvektoranalyse",
            clinicallyMatched: "Klinisch abgestimmte Formeln",
            flow: {
                diagnosis: "Diagnose",
            ...
            journeySub: "Ein biometrisch präziser Ablauf — von intelligenter klinischer Analyse bis hin zu einem lebendigen, personalisierten europäisch-koreanischen Protokoll.",
            readyTitle: "Bereit, Ihre Haut zu entschlüsseln?",
            readySub: "Keine Registrierung · Ergebnisse in unter 6 Min · Unterstützt durch klinische Skalen",
        ...
        profileTab: {
            ...
            vectorOptimized: "Vektor im Vergleich zur vorherigen Diagnose optimiert",
        ...
        diagnosis: {
            ...
            completing: "10-Achsen-Strategie wird synchronisiert...",
            ...
            loading: [
                "Symptomprofil wird kartiert...",
                "10 klinische Achsen werden bewertet...",
            ...
            progress: {
                ...
                encFinal: "Diagnose abgeschlossen! Hochpräziser Bericht wird geladen...",
        ...
        results: {
            ...
            deviceGated: "Gerät gesperrt: Ihr Barriere-Score ({score}) zeigt, dass Monat 1 auf Reparatur fokussieren sollte. Das klinische Gerät wird in Monat 2 geliefert, sobald Stabilität bestätigt ist.",
            deviceUnlocked: "Barriere stabil · Klinisches Gerät freigeschaltet",
            deviceUnlockedDesc: "Ihr Barriere-Score qualifiziert Sie für sofortigen Zugang zum Gerät. Das klinische Gerät wird mit Ihrer Bestellung für Monat 1 geliefert.",
            ...
            premiumTimingDesc: "Das klinische EMS / LED-Gerät ist eine Lease-to-Own-Prämie, kein Erstmonatsgeschenk. Es wird erst nach Bestätigung der Barriere-Stabilität geliefert — normalerweise im 2. Monat. Dies schützt reaktive Haut vor vorzeitiger Gerätestimulation und stellt sicher, dass Ergebnisse vor dem Versand messbar sind.",
            formulasMatched: "auf Ihren Vektor abgestimmte Formulierungen",
            personalizedSelection: "Personalisierte Auswahl",
            selectionReason: "Jedes Produkt wurde aufgrund spezifischer Signale in Ihrer Diagnose ausgewählt — nicht nur aufgrund Ihres Hauttyps allein.",
            ...
            becauseObserved: "Klinische Beobachtung",
            helpsBy: "Dieses Produkt hilft durch",
            orderSummary: "Bestellübersicht",
            protocol: "Protokoll",
            whatsIncluded: "Was enthalten ist",
            leaseToOwn: "Lease-to-Own-Sicherheit: Das klinische Gerät wird im 2. Monat nach Bestätigung der Barrierebereitschaft geliefert. Volles Eigentum geht nach 3 Monaten über. Keine versteckten Kosten.",
        ...
        skinAnalysis: {
            ...
            pageDescription: "Analysieren Sie Ihre Haut in 10 Achsen mit einer 60-Sekunden-KI-Diagnose und erhalten Sie personalisierte Hautpflege-Empfehlungen.",
