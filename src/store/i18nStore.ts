...
export const translations = {
    en: {
        ...
        results: {
            ...
            deviceUnlocked: "Barrier Stable · Professional Device Eligible",
            ...
            premiumTimingDesc: "The Professional EMS / LED Device is a lease-to-own reward, not a first-month gift. It ships only after your barrier stability is confirmed — typically Month 2. This protects reactive skin from premature device stimulation and ensures results are measurable before dispatch.",
            ...
            leaseToOwn: "Lease-to-own safety: Professional device ships in Month 2 after barrier readiness is confirmed. Full ownership transfers after 3 months. No surprise charges.",
...
export const phase1T = {
    ...
    en: {
        ...
        home: {
            ...
            routineSub: "Expertly curated skincare sets — matched to your skin data.",
            routines: [
